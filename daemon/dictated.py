...
OPEN_DICTATE_LEXICON_ROOT = Path(os.environ.get("OPEN_DICTATE_LEXICON_ROOT", str(DEFAULT_LEXICON_ROOT))).expanduser()
...
sys.path.insert(0, str(OPEN_DICTATE_LEXICON_ROOT / "tools" / "muse-lexicon"))
...
# ---------------------------------------------------------------------------
PUNCT_LLM_URL = os.environ.get("OPEN_DICTATE_PUNCT_LLM_URL", "http://127.0.0.1:11434/api/chat")
PUNCT_LLM_MODEL = os.environ.get("OPEN_DICTATE_PUNCT_MODEL", "qwen3.6:35b-a3b-coding-nvfp4")
...
PUNCT_LLM_KEEP_ALIVE = os.environ.get("OPEN_DICTATE_KEEP_ALIVE", "24h")
